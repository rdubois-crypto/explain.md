...
// apdu to test both group commitment
// from file 301025
int handler_cmd_PartialSig(buffer_t *cdata)
{
  ZKN_ERROR_INIT();
...
int handler_cmd_frost_inject(buffer_t *cdata)
{
  ZKN_ERROR_INIT();
...
int handler_cmd_frost_commit(buffer_t *cdata)
{
  ZKN_ERROR_INIT();
  uint8_t out[128];
  ZKN_CHECK(cx_bn_lock(32, 0));
...
int handler_cmd_frost_inject_com1(buffer_t *cdata)
{
  ZKN_ERROR_INIT();
...
int handler_cmd_frost_inject_com2(buffer_t *cdata)
{
  ZKN_ERROR_INIT();
...
int handler_cmd_frost_partial_sign(buffer_t *cdata)
{
  ZKN_ERROR_INIT();
...
int handler_cmd_inject_nonces(buffer_t *cdata)
{
  ZKN_ERROR_INIT();
